...
#define	MSINI_Model			MsgIni[1]	// " 機種 60:PC-6001 61:PC-6001A 62:PC-6001mk2 66:PC-6601"
...
// [DISPLAY]
#define	MSINI_Mode4Color	MsgIni[11]	// " MODE4カラーモード 0:モノクロ 1:赤/青 2:青/赤 3:ピンク/緑 4:緑/ピンク"
#define	MSINI_ScanLine		MsgIni[12]	// " スキャンライン Yes:あり No:なし"
#define	MSINI_ScanLineBr	MsgIni[13]	// " スキャンライン輝度 (0-100)%"
#define	MSINI_DispNTSC		MsgIni[14]	// " 4:3表示 Yes:有効 No:無効"
#define	MSINI_FullScreen	MsgIni[15]	// " フルスクリーンモード Yes:有効 No:無効"
#define	MSINI_DispStatus	MsgIni[16]	// " ステータスバー Yes:表示 No:非表示"
#define	MSINI_FrameSkip		MsgIni[17]	// " フレームスキップ"
// [SOUND]
#define	MSINI_SampleRate	MsgIni[18]	// " サンプリングレート (44100/22050/11025)Hz"
#define	MSINI_SoundBuffer	MsgIni[19]	// " サウンドバッファサイズ"
#define	MSINI_MasterVolume	MsgIni[29]	// " マスター音量 (0-100)"
#define	MSINI_PsgVolume		MsgIni[21]	// " PSG音量 (0-100)"
#define	MSINI_VoiceVolume	MsgIni[22]	// " 音声合成音量 (0-100)"
#define	MSINI_TapeVolume	MsgIni[23]	// " TAPEモニタ音量 (0-100)"
#define	MSINI_PsgLPF		MsgIni[24]	// " PSG LPFカットオフ周波数(0で無効)"
// [MOVIE]
#define	MSINI_AviBpp		MsgIni[25]	// " ビデオキャプチャ色深度 (16,24,32)"
// [FILES]
#define	MSINI_ExtRom		MsgIni[26]	// " 拡張ROMファイル名"
#define	MSINI_tape			MsgIni[27]	// " TAPE(LODE)ファイル名(起動時に自動マウント)"
#define	MSINI_save			MsgIni[28]	// " TAPE(SAVE)ファイル名(SAVE時に自動マウント)"
#define	MSINI_disk1			MsgIni[29]	// " DISK1ファイル名(起動時に自動マウント)"
#define	MSINI_disk2			MsgIni[30]	// " DISK2ファイル名(起動時に自動マウント)"
...
#define	MSINI_DokoSavePath	MsgIni[41]	// " どこでもSAVE格納パス"
// [CHECK]
